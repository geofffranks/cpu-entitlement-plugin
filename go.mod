...
require (
	...
	code.cloudfoundry.org/test-log-emitter v0.0.0-20230112145843-ee135a470ca1
...
require (
	...
	code.cloudfoundry.org/go-diodes v0.0.0-20230109184538-4158d99ba5db // indirect
	...
	github.com/cloudfoundry/bosh-utils v0.0.349 // indirect
